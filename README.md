...
| `comics` | 漫画 | `1.0.9` | 2 | 连续滚动或左右单页翻阅图片目录与 CBZ/ZIP 漫画包 |
...
- `apps/<id>-<version>.tgapp`（各官方插件最新打包文件，例如 `shorts-1.0.3.tgapp`、`books-1.1.4.tgapp`、`comics-1.0.9.tgapp`、`cinema-1.1.2.tgapp`）
