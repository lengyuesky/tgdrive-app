...
| `books` | 图书 | `1.3.3` | 2 | 阅读 TXT、EPUB 2/3 与中文字体 PDF，支持排版偏好、书签与跨设备进度 |
| `comics` | 漫画 | `1.2.3` | 2 | 连续滚动或左右单页翻阅图片目录与 CBZ/ZIP 漫画包 |
...
- `apps/<id>-<version>.tgapp`（各官方插件最新打包文件，例如 `shorts-1.1.1.tgapp`、`books-1.3.3.tgapp`、`comics-1.2.1.tgapp`、`cinema-1.2.3.tgapp`）
