...
|---|---|---|---|---|
| `shorts` | 短视频 | `1.1.2` | 2 | 随机播放网盘文件夹里的视频，支持滑动切换、收藏与下载 |
| `books` | 图书 | `1.3.8` | 2 | 阅读 TXT、EPUB 2/3 与中文字体 PDF，支持排版偏好、书签与跨设备进度 |
| `comics` | 漫画 | `1.2.10` | 2 | 连续滚动或左右单页翻阅图片目录与 CBZ/ZIP 漫画包 |
| `cinema` | 影视 | `1.2.5` | 2 | 命名媒体库、封面缓存优化、文本字幕、音轨切换与客户端 MKV 流式解封装 |
...
- `apps/<id>-<version>.tgapp`（各官方插件最新打包文件，例如 `shorts-1.1.2.tgapp`、`books-1.3.8.tgapp`、`comics-1.2.10.tgapp`、`cinema-1.2.5.tgapp`）
